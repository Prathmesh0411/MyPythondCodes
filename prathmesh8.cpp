...
void binary::prep(bool b){ //add bit at the begining
if(start == NULL){
start = new node(b);
end = start ;
}
...
break ;
case 2:
cout << "Enter the decimal number to generate binary and display 1's
complement : " ;
cin >> n ;
b.DtoB(n) ;
...
break ;
case 3:
cout << "Enter the decimal number to generate binary and display 2's
complement : " ;
cin >> n ;
b.DtoB(n) ;
